const CACHE='aurora-ai-v23';
const SHELL=['/','/styles.css?v=8','/admin.css?v=18','/enhancements.css?v=20','/app.js?v=23','/manifest.webmanifest','/assets/aurora-ai-hero.png','/assets/models/uncensored.svg','/assets/models/chatgpt.svg','/assets/models/gemini.svg','/assets/models/image.svg','/assets/models/video.svg'];
