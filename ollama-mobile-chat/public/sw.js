const CACHE='aurora-ai-v21';
const SHELL=['/','/styles.css?v=8','/admin.css?v=17','/enhancements.css?v=19','/app.js?v=21','/manifest.webmanifest','/assets/aurora-ai-hero.png','/assets/models/uncensored.svg','/assets/models/chatgpt.svg','/assets/models/gemini.svg','/assets/models/image.svg','/assets/models/video.svg'];
