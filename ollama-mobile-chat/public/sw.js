const CACHE='aurora-ai-v28';
const SHELL=['/','/styles.css?v=8','/admin.css?v=18','/enhancements.css?v=24','/app.js?v=25','/manifest.webmanifest','/assets/aurora-ai-hero.png','/assets/models/uncensored.svg','/assets/models/chatgpt.svg','/assets/models/gemini.svg','/assets/models/image.svg','/assets/models/video.svg'];
